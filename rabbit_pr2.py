...
class Publisher:
    ...
    def publish(self, routing_key, message):       
       ...
       # Creates an exchange if it does not already exist, and if the exchange exists, verifies that it is of the correct and expected class.
...
publisher.publish('test_q3', 'New Data')