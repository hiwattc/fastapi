...
class Subscriber:
  ...
  def setup(self):
      ...
      channel.exchange_declare(exchange='my_exchange_dlx', exchange_type='direct')
      # This method creates or checks a queue
      channel.queue_declare(queue=self.queueName
                          , arguments={
                                       'x-message-ttl':10000,
                                       "x-dead-letter-exchange" : "my_exchange_dlx"
                                       })
      channel.queue_declare(queue='test_dlxq1')
      ...
      channel.queue_bind(queue='test_dlxq1',exchange='my_exchange_dlx', routing_key='task_queue')
